          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <svg className="w-6 h-6 text-[#028a04] mr-4 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <div>
                  <h3 className="font-semibold text-[#028a04]">Office Address</h3>
                  <p className="text-gray-600">123 Sustainability Drive, Abuja, Nigeria</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-[#028a04]">Email</h3>
                  <p className="text-gray-600">info@faabyglobal.org</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-[#028a04]">Phone</h3>
